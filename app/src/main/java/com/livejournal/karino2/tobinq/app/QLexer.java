// $ANTLR 3.5.2 Q.g 2014-04-17 06:49:24
...
public class QLexer extends Lexer {
	...
	public final void mHexLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Q.g:288:12: ( '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )? )
			// Q.g:288:14: '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )?
			{
			match('0'); 
	...
	public final void mDecimalLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Q.g:290:16: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )? )
			// Q.g:290:18: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )?
			{
			// Q.g:290:18: ( '0' | '1' .. '9' ( '0' .. '9' )* )
			int alt4=2;
	...
	public final void mOctalLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Q.g:292:14: ( '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )? )
			// Q.g:292:16: '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )?
			{
			match('0'); 
			// Q.g:292:20: ( '0' .. '7' )+
			int cnt6=0;
	...
	public final void mFloatingPointLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Q.g:302:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ FloatTypeSuffix )
			int alt18=4;
			alt18 = dfa18.predict(input);
			switch (alt18) {
				case 1 :
					// Q.g:302:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )?
					{
					// Q.g:302:9: ( '0' .. '9' )+
					int cnt8=0;
					loop8:
	...
	public final void mSTR_CONST() throws RecognitionException {
		try {
			int _type = STR_CONST;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Q.g:341:5: ( '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( EscapeSequence |~ ( '\\'' | '\\\\' ) )* '\\'' )
			int alt23=2;
			...
			switch (alt23) {
				case 1 :
					// Q.g:341:8: '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"'
					{
					match('\"'); 
					// Q.g:341:12: ( EscapeSequence |~ ( '\\\\' | '\"' ) )*
					loop21:
					while (true) {
						int alt21=3;
	...
	public final void mEscapeSequence() throws RecognitionException {
		try {
			// Q.g:348:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape )
			int alt24=3;
	...
	public final void mOctalEscape() throws RecognitionException {
		try {
			// Q.g:355:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
			int alt25=3;
	...
	public final void mUnicodeEscape() throws RecognitionException {
		try {
			// Q.g:362:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
			// Q.g:362:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
			{
			match('\\'); 
			match('u'); 
			mHexDigit(); 
	...
	public final void mLetter() throws RecognitionException {
		try {
			// Q.g:374:5: ( '\\u002e' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
			// Q.g:
			{
	...
	public final void mJavaIDDigit() throws RecognitionException {
		try {
			// Q.g:393:5: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06f0' .. '\\u06f9' | '\\u0966' .. '\\u096f' | '\\u09e6' .. '\\u09ef' | '\\u0a66' .. '\\u0a6f' | '\\u0ae6' .. '\\u0aef' | '\\u0b66' .. '\\u0b6f' | '\\u0be7' .. '\\u0bef' | '\\u0c66' .. '\\u0c6f' | '\\u0ce6' .. '\\u0cef' | '\\u0d66' .. '\\u0d6f' | '\\u0e50' .. '\\u0e59' | '\\u0ed0' .. '\\u0ed9' | '\\u1040' .. '\\u1049' )
			// Q.g:
			{
	...
	public final void mSYMBOL() throws RecognitionException {
		try {
			int _type = SYMBOL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Q.g:411:2: ( Letter ( Letter | JavaIDDigit )* )
			// Q.g:411:6: Letter ( Letter | JavaIDDigit )*
			{
			mLetter(); 

			// Q.g:411:13: ( Letter | JavaIDDigit )*
			loop26:
			while (true) {
				int alt26=2;
	...
	protected class DFA18 extends DFA {
		...
		public String getDescription() {
			return "301:1: FloatingPointLiteral : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ FloatTypeSuffix );";
		}
	}
